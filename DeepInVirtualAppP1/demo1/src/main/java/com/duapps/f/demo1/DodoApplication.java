...
import com.duapps.f.patch.PatchManager;
...
//        mainThread = ActivityThread.currentActivityThread();
        try {
            Method m = ActivityThread.class.getDeclaredMethod("currentActivityThread");
            m.setAccessible(true);
            Object o = m.invoke(null);
            mainThread = (ActivityThread) o;
...
//        processName = mainThread.getProcessName();
        try {
            Method m = ActivityThread.class.getDeclaredMethod("getProcessName");
            m.setAccessible(true);
            Object o = m.invoke(mainThread);
            processName = (String) o;
        } catch (NoSuchMethodException e) {
            e.printStackTrace();
        } catch (IllegalAccessException e) {
            e.printStackTrace();
