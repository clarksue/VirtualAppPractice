...
import com.duapps.f.virtualappp1.abs.ui.VFragment;
import com.duapps.f.virtualappp1.abs.ui.VUiKit;
import com.duapps.f.virtualappp1.home.adapters.CloneAppListAdapter;
...
import com.duapps.f.virtualappp1.widgets.DragSelectRecyclerView;
...
public class ListAppFragment extends VFragment<ListAppContract.ListAppPresenter> implements ListAppContract.ListAppView {
    ...
    public void loadFinish(List<AppInfo> infoList) {
        if (infoList != null && infoList.size() > 20) {
            infoList.subList(0, 20);
        }
