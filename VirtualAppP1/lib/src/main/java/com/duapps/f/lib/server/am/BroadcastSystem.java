...
import com.duapps.f.lib.server.pm.parser.VPackage;
...
public class BroadcastSystem {
     ...
     * at com.duapps.f.lib.server.am.BroadcastSystem.startApp(BroadcastSystem.java:54)
     * at com.duapps.f.lib.server.pm.VAppManagerService.install(VAppManagerService.java:193)
     * at com.duapps.f.lib.server.pm.VAppManagerService.preloadAllApps(VAppManagerService.java:98)
     * at com.duapps.f.lib.server.pm.VAppManagerService.systemReady(VAppManagerService.java:70)
     * at com.duapps.f.lib.server.BinderProvider.onCreate(BinderProvider.java:42)
     */
