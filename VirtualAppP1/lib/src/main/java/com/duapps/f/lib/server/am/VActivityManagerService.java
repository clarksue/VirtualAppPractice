package com.duapps.f.lib.server.am;
...
import com.duapps.f.lib.client.IVClient;
import com.duapps.f.lib.client.core.VirtualCore;
import com.duapps.f.lib.client.env.SpecialComponentList;
import com.duapps.f.lib.client.ipc.ProviderCall;
import com.duapps.f.lib.client.ipc.VNotificationManager;
import com.duapps.f.lib.client.stub.VASettings;
import com.duapps.f.lib.helper.collection.ArrayMap;
import com.duapps.f.lib.helper.collection.SparseArray;
import com.duapps.f.lib.helper.compat.ActivityManagerCompat;
import com.duapps.f.lib.helper.compat.ApplicationThreadCompat;
import com.duapps.f.lib.helper.compat.BundleCompat;
import com.duapps.f.lib.helper.compat.IApplicationThreadCompat;
import com.duapps.f.lib.helper.utils.ComponentUtils;
import com.duapps.f.lib.helper.utils.VLog;
import com.duapps.f.lib.os.VBinder;
...
import com.duapps.f.lib.server.interfaces.IProcessObserver;
import com.duapps.f.lib.server.pm.PackageCacheManager;
import com.duapps.f.lib.server.pm.PackageSetting;
import com.duapps.f.lib.server.pm.VAppManagerService;
import com.duapps.f.lib.server.pm.VPackageManagerService;
import com.duapps.f.lib.server.secondary.BinderDelegateService;
...
import static com.duapps.f.lib.os.VBinder.getCallingPid;
